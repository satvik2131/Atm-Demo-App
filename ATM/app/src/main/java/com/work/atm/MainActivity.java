...
import com.work.atm.Login.SignupActivity;
...
public class MainActivity extends AppCompatActivity implements UserCallBack {
    ...
    private Button btnChangeEmail, btnChangePassword, btnSendResetEmail, btnRemoveUser,
            changeEmail, changePassword, bankAccount, sendEmail, remove, signOut;
...
//                    UserRepository.getInstance().fetchLoggedInUser(MainActivity.this);
    ...
    public void onLoggedInUserCallback(User user) {
        ...
        loggedInUser = user;
        startActivity(new Intent(MainActivity.this, user.getAdmin() ? AdminDashBoardActivity.class : UserDashBoardActivity.class));
    }
...
//        bankAccount = (Button) findViewById(R.id.bank_account);
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        refUser.setUserId(user.getUid());
                                        UserRepository.getInstance().delete(refUser);
