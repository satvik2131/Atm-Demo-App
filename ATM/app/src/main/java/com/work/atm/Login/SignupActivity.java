                        ...
                        .addOnCompleteListener(SignupActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    if(fbUser == null) {
                                        Toast.makeText(SignupActivity.this, "User detail missing from firebase." + task.getException(),
                                                Toast.LENGTH_SHORT).show();
                                    ...
                                    User user = new User(fbUser.getUid(), fbUser.getEmail(), 0L, UserRepository.getInstance().findIfAdmin(fbUser.getEmail()));
